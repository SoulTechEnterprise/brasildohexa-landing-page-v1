            ...
            <div className="max-w-2xl w-full">
                <div className="flex justify-center mb-6 md:mb-8">
                    <div className="relative">
                        ...
                        <div className="relative bg-green-500/10 p-5 md:p-8 rounded-full border-4 border-green-500">
                            <CheckCircle2 className="size-16 md:size-24 text-green-500" strokeWidth={2} />
                        </div>
                    </div>
                </div>
